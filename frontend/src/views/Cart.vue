  ...
  <el-card>
    ...
    <div v-if="cart.items?.length" style="margin-top:20px">
      ...
      <el-form :model="info" label-width="100px" inline>
        <el-form-item label="收件人"><el-input v-model="info.recipient_name" /></el-form-item>
        <el-form-item label="联系电话"><el-input v-model="info.recipient_phone" /></el-form-item>
        <el-form-item label="收件地址"><el-input v-model="info.recipient_address" style="width:300px" /></el-form-item>
        <el-form-item label="货物重量(kg)"><el-input-number v-model="info.total_weight" :min="0" :precision="2" /></el-form-item>
        <el-form-item label="运输要求"><el-input v-model="info.shipping_req" /></el-form-item>
      </el-form>
